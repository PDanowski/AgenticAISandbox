...
- DevOps: Azure infrastructure, Terraform modules, environment setup, and pipelines.
...
- DevOps IaC + pipeline definitions
...
- Infrastructure reproducible with Terraform across `dev/test/prod`.
- CI/CD configured for each new service.
